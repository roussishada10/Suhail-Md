...
global.devs = "212775322160" // Developer Contact
...
module.exports = {
  ...
  author : process.env.PACK_AUTHER|| "roussisaad",
  packname: process.env.PACK_NAME || "♥️",
  botname : process.env.BOT_NAME  || "saad-ᴍᴅ",
  ...
  LANG: process.env.THEME ? process.env.THEME.toUpperCase() : "SAAD",
